...
def extract_graph_feature_from_networkx(
    ...
    return adjacent, features, static_features, topo_features
...
def extract_graph_feature(onnx_path, batch_size, embed_type, return_onnx=False):
    ...
    if return_onnx:
        return adjacent, np.array(features), static_features, onnx_G, topo_features
    else:
        return adjacent, np.array(features), static_features, topo_features
